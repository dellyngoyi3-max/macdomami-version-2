...
|---|---|---|
| **Numéro WhatsApp** (reçoit commandes, réservations, devis) | `243999907678` (dans `js/data.js`) | ✅ **RÉEL** (fourni : 099 990 768 78) |
| Téléphone affiché | `+243 999 907 678` | ✅ RÉEL |
...
├── contact.html        # Contact, horaires, zones de livraison
├── confidentialite.html# Politique de confidentialité
├── css/styles.css      # tout le design (couleurs, polices, mise en page)
├── js/
