...
const CONFIG = {
  ...
  /* ---------- Contact ---------- */
  whatsapp: "243999907678",        // ← Numéro WhatsApp SANS "+" (fourni : 099 990 768 78)
  telephone: "+243 999 907 678",
  ...
  url: "https://macdomami.cd",     // ← URL réelle à mettre à jour (ex. GitHub Pages)
  reseaux: {
